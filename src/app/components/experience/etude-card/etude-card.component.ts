...
@Component({
  ...
  template: `
    <div 
      class="p-6 rounded-xl transition-all duration-500 ease-out w-full group/card hover:-translate-y-2"
      [ngClass]="{
    ...
    >
      <div class="flex flex-col" [ngClass]="{'md:items-end': !isLeft, 'md:items-start': isLeft}">
        ...
        <div class="flex items-center gap-2 mb-2" [ngClass]="{'md:justify-end': !isLeft}">
