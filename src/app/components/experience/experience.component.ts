...
@Component({
  ...
  template: `
    <section class="h-full w-full flex flex-col justify-center p-4 md:p-20 relative">
      <h2 i18n class="text-4xl md:text-6xl font-bold text-white mb-8 md:mb-12 border-l-4 border-teal-500 pl-6">
      ...
      <div class="flex justify-center gap-3 mb-8 md:mb-12">
        <button 
        ...
        <button 
          ...
          <span i18n>Études</span>
        </button>
      </div>
      
      <div class="relative w-full max-w-5xl mx-auto h-[70vh] group">
        
        <div class="h-full overflow-y-auto scrollbar-hide py-8 px-4 md:px-10 space-y-24 md:space-y-32 mask-gradient" #scrollContainer>
          ...
          <div class="relative min-h-full">
            ...
            @for (exp of currentItems(); track exp.id; let i = $index; let isEven = $even) {
              <div #experienceItems
