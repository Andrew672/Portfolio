...
@Component({
  ...
  template: `
    <section class="h-full w-full flex flex-col justify-center p-8 md:p-20 z-10 relative">
      <h2 class="text-4xl md:text-6xl font-bold text-white mb-12 border-l-4 border-teal-500 pl-6">Mes Projets</h2>
